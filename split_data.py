...
or_test_data = []
test_file = open('./Data/x_test.txt', 'r', encoding="utf-8") 
for line in test_file: 
    or_test_data.append(line)
test_file.close()

or_test_labels = [] 
test_lab_file = open('./Data/y_test.txt', 'r', encoding="utf-8") 
for line in test_lab_file: 
    or_test_labels.append(line)
test_lab_file.close()

train_data = []
train_file = open('./Data/x_train.txt', 'r', encoding="utf-8") 
for line in train_file: 
    train_data.append(line)
train_file.close()

train_labels = [] 
train_lab_file = open('./Data/y_train.txt', 'r', encoding="utf-8") 
...
with open('./Data/x_train_split.txt', 'w', encoding="utf-8") as f:
    for item in train_data:
        f.write("%s" % item)
f.close()

with open('./Data/y_train_split.txt', 'w', encoding="utf-8") as f:
    for item in train_labels:
        f.write("%s" % item)
f.close()

# write new validation files
with open('./Data/x_valid_split.txt', 'w', encoding="utf-8") as f:
    for item in valid_data:
        f.write("%s" % item)
f.close()

with open('./Data/y_valid_split.txt', 'w', encoding="utf-8") as f:
    for item in valid_labels:
        f.write("%s" % item)
f.close()

# write new test files
with open('./Data/x_test_split.txt', 'w', encoding="utf-8") as f:
    for item in test_data:
        f.write("%s" % item)
f.close()

with open('./Data/y_test_split.txt', 'w', encoding="utf-8") as f:
